...
public class JsCallJava {
    ...
    public JsCallJava (String injectedName, Object injectedObj) {
        try {
            ...
            Class injectedCls = injectedObj.getClass();
            ...
            for (Method method : methods) {
                String sign;
                if (!method.isAnnotationPresent(JavascriptInterface.class) || (sign = genJavaMethodSign(method)) == null) {
                    continue;
                }
